        ...
        idOrder === null ? (
          <form onSubmit={handleSubmitForm} className="form-checkout" >
            ...
            <div className="content-input">
              ...
              <input className="input" type="text" name="fullname" value={dataForm.fullname} onChange={handleChangeInput} />
            </div>

            <div className="content-input">
              <label className="label">Telefono:</label>
              <input className="input" type="number" name="phone" value={dataForm.phone} onChange={handleChangeInput} />
            </div>

            <div className="content-input">
              <label className="label">Email:</label>
              <input className="input" type="email" name="email" value={dataForm.email} onChange={handleChangeInput} />
            </div>
          ...
          <div>
            ...
            <Link to="/" className="button-send-order">Volver al inicio</Link>
          </div>
        )
      }
